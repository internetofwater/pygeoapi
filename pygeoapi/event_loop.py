...
_CUSTOM_EVENT_LOOP_MODULE: Optional[str] = \
    os.getenv("PYGEOAPI_CUSTOM_EVENT_LOOP_MODULE")
# The function that can be called for retrieving the event loop
_CUSTOM_EVENT_LOOP_GETTER: Optional[str] = \
    os.getenv("PYGEOAPI_CUSTOM_EVENT_LOOP_GETTER")
...
if _CUSTOM_EVENT_LOOP_MODULE and _CUSTOM_EVENT_LOOP_GETTER:
    ...
    try:
        get_loop = getattr(event_loop_module, _CUSTOM_EVENT_LOOP_GETTER)
